...
const vT=[...document.querySelectorAll(".videos-test")];
const vb1=[...document.querySelectorAll(".prevButton-test")];
const vb2=[...document.querySelectorAll(".nextButton-test")];
...
vb1[i].addEventListener("click",()=>{
    item.scrollLeft -=cW;
})
vb2[i].addEventListener("click",()=>{
    item.scrollLeft +=cW;
})
});
...
/*const vT=document.querySelector(".videos-test");
const vI=document.querySelectorAll(".bye");

let counter=0;

function nextTest(){
   if(counter>=vI.length-1) return;
   counter++;
   vT.style.transform=`translateX(-${counter*250}px)`;
}
function prevTest(){
   if(counter<=0) return;
   counter--;
...
setInterval(nextTest,3000);

const vbT1=document.querySelector(".prevButton-test");
const vbT2=document.querySelector(".nextButton-test");


vbT1.addEventListener("click",prevTest);
vbT2.addEventListener("click",nextTest);*/
//gallery
